...
movie.reviews.create!(name: "Roger Ebert", location: 'Chicago, IL', stars: 3, comment: "I laughed, I cried, I spilled my popcorn!")
movie.reviews.create!(name: "Gene Siskel", location: 'New York City, NY', stars: 5, comment: "I'm a better reviewer than he is.")
movie.reviews.create!(name: "Peter Travers", location: 'Los Angeles, CA', stars: 4, comment: "It's been years since a movie superhero was this fierce and this funny.")

movie = Movie.find_by(title: 'Superman')
movie.reviews.create!(name: "Elvis Mitchell", location: 'Dallas, TX', stars: 5, comment: "It's a bird, it's a plane, it's a blockbuster!")